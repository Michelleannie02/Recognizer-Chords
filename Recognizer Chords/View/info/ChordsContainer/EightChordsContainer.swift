...
/* Abstract:
Esta clase representa una vista que contiene información acerca de los ocho acordes que incluye esta pantalla.
*/

class EightChordsContainer: UICollectionView {
