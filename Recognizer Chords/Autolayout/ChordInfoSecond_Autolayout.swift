...
extension ChordsInfoSecondViewController {
	...
	func autolayout () {
		...
		NSLayoutConstraint.activate([
			...
			majorView.trailingAnchor.constraint(equalTo: dimView.leadingAnchor),
			...
			minorView.trailingAnchor.constraint(equalTo: augView.leadingAnchor),
			...
			dimLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
			...
			dimInfoLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
			...
			augLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
			...
			dimInfoLabel.topAnchor.constraint(equalTo: augNotationImage.bottomAnchor, constant: 30),
			dimInfoLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
